select oo.lead_id
        ,oo.store_id
        ,COALESCE(oo.dealer_id,gfd.sale_confirmed_fk_dealer_id) as dealer_id
...
left join (select distinct fk_order_id, date(GFD_AT) GFD_Date ,sale_confirmed_fk_dealer_id
